...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class DscCompilationJobCreateParameters
    {
        ...
        /// resource.</param>
        public DscCompilationJobCreateParameters(DscConfigurationAssociationProperty configuration, IDictionary<string, string> parameters = default(IDictionary<string, string>), string name = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
