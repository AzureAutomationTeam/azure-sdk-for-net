...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class ConnectionType
    {
        ...
        public ConnectionType(string id = default(string), string name = default(string), bool? isGlobal = default(bool?), System.Collections.Generic.IDictionary<string, FieldDefinition> fieldDefinitions = default(System.Collections.Generic.IDictionary<string, FieldDefinition>), System.DateTime? creationTime = default(System.DateTime?), System.DateTime? lastModifiedTime = default(System.DateTime?), string description = default(string))
        {
            this.Id = id;
            this.Name = name;
