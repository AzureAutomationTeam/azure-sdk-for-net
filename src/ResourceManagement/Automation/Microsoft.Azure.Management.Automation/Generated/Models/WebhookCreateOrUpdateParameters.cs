...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class WebhookCreateOrUpdateParameters
    {
        ...
        public WebhookCreateOrUpdateParameters(string name, bool? isEnabled = default(bool?), string uri = default(string), System.DateTime? expiryTime = default(System.DateTime?), System.Collections.Generic.IDictionary<string, string> parameters = default(System.Collections.Generic.IDictionary<string, string>), RunbookAssociationProperty runbook = default(RunbookAssociationProperty), string runOn = default(string))
        {
            this.Name = name;
