...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class ModuleUpdateParameters
    {
        ...
        /// resource.</param>
        public ModuleUpdateParameters(ContentLink contentLink = default(ContentLink), string name = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>))
        {
