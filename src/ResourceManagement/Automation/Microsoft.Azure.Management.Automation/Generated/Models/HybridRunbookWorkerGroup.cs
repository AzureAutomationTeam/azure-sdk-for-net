...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class HybridRunbookWorkerGroup
    {
        ...
        /// group.</param>
        public HybridRunbookWorkerGroup(string id = default(string), string name = default(string), System.Collections.Generic.IList<HybridRunbookWorker> hybridRunbookWorkers = default(System.Collections.Generic.IList<HybridRunbookWorker>), RunAsCredentialAssociationProperty credential = default(RunAsCredentialAssociationProperty))
        {
            this.Id = id;
            this.Name = name;
        ...
        public System.Collections.Generic.IList<HybridRunbookWorker> HybridRunbookWorkers { get; set; }
