...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class WebhookUpdateParameters
    {
        ...
        /// webhook.</param>
        public WebhookUpdateParameters(string name, bool? isEnabled = default(bool?), string runOn = default(string), System.Collections.Generic.IDictionary<string, string> parameters = default(System.Collections.Generic.IDictionary<string, string>), string description = default(string))
        {
            this.Name = name;
