...
namespace Microsoft.Azure.Management.Automation.Models
{
    ...
    public partial class AutomationAccountCreateOrUpdateParameters
    {
        ...
        /// resource.</param>
        public AutomationAccountCreateOrUpdateParameters(Sku sku = default(Sku), string name = default(string), string location = default(string), System.Collections.Generic.IDictionary<string, string> tags = default(System.Collections.Generic.IDictionary<string, string>))
        {
            this.Sku = sku;
            this.Name = name;
